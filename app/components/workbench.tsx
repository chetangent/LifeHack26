...
function OptimizeView({ handleExport, handleOptimizeSelected, isOptimized, isOptimizing, onSelectProduct, products, scoreDelta, selectedProduct, status, suggestedFixes, optimizationMeta }: OptimizeViewProps) {
  return (
    <>
      <section className="workspace-heading"><div><p className="eyebrow">Focused step · 02</p><h2>Make one product easier to recommend.</h2><p className="section-copy">AgentShelf has already found the highest-impact fixes for the selected SKU.</p></div></section>
...
function EvidenceView({ baselinePrompts, handleExport, handleOptimizeSelected, improvedPrompts, isOptimized, onSelectProduct, products, scoreDelta, selectedProduct, simulatedWinDelta, status, optimizationMeta }: EvidenceViewProps) {
  ...
  return <>
    <section className="workspace-heading"><div><p className="eyebrow">Focused step · 03</p><h2>Prove the lift.</h2><p className="section-copy">See the outcome first, then open the evidence behind the score when you need it.</p></div></section>
